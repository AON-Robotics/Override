...
# Paste the complete export into static/path.jerryio.txt, then build and upload.
...
$(STATIC_PATH_HEADER): $(ROOT)/static/path.jerryio.txt $(ROOT)/tools/generate-static-path.py
